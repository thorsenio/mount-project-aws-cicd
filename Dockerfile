...
ENV \
  ...
  PATH="${PLATFORM_DIR}/aws/acm:${PLATFORM_DIR}/aws/cloudformation:${PLATFORM_DIR}/aws/codecommit:${PLATFORM_DIR}/aws/ec2:${PLATFORM_DIR}/aws/ecr:${PLATFORM_DIR}/aws/route53:${PLATFORM_DIR}/aws/s3:${PLATFORM_DIR}/docker:${PLATFORM_DIR}/scripts:${PATH}" \
